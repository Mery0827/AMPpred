...
# 当前文件所在目录: code/train/stage-2/V2/
...
# ==================== 【实验版本控制矩阵】=====================
EXPERIMENT_TAG = "v2_focal_global"  # ← v2 配置

USE_FOCAL_LOSS = True  # ← v2 配置
...
# 结果保存到当前脚本同级目录（如 code/train/stage-2/V2/results/v2_focal_global/）
